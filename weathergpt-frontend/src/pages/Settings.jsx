    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-card">
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50/80 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/80">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/30 flex items-center justify-center text-lg">
                🌙
              </div>
              <div>
                <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Permanent Dark Mode</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">Deep midnight contrast for dynamic weather atmosphere & eye comfort.</p>
              </div>
            </div>
