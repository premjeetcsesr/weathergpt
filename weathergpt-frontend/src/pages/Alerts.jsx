      ...
      {activeTab === 'active' && (
        <div className="space-y-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border border-red-200 dark:border-red-900/50">
            ...
            <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800">
              ...
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200">
                No active severe weather alerts detected for {selectedCity || 'this location'}
              </h3>
              <p className="text-xs text-slate-400 mt-1 max-w-md mx-auto">
                {providerNote || 'No official severe disaster or storm warnings are currently issued by meteorological authorities for this location.'}
              </p>
            </div>
          )}
        </div>
