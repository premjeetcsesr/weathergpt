...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 lg:w-72 xl:w-80 shrink-0 bg-[#0c1527] border-r border-[#1a2c4e] sticky top-16 h-[calc(100vh-4rem)] p-4 lg:p-5 xl:p-6 transition-all duration-300 z-30 overflow-y-auto">
      {/* Navigation Links */}
